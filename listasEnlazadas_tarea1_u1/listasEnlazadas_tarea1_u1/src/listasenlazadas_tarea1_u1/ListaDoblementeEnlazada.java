...
public class ListaDoblementeEnlazada {
    ...
    public void agregarI(int i , Object dato) {
    ...
    public ListaDoblementeEnlazada copiar(ListaDoblementeEnlazada A){
        ListaDoblementeEnlazada newlist = new ListaDoblementeEnlazada();
        newlist.cabeza = A.cabeza;
        newlist.cola = A.cola;
        return newlist;
    }
...
//--------------------------------------------------------------------------------------
    ...
    // Eliminar un elemento de la lista, en su primera ocurrencia
