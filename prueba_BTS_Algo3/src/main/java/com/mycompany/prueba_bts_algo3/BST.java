 ...
 */
package com.mycompany.prueba_bts_algo3;
 ...
 * Al compilar posiblemente se encuentre con algunas advertencias.
 * Explique en la solución del ejercicio 0 porque se da estos mensajes. Hint: pruebe compilar con -Xlint 
 * ---------------------------------------
 */
